...
== DIRECTORY OPTIONS
*checkdiff*::
    Flag whether to add the diff of a change to the report. Might leak sensitive informations in alerts! Defaults to _false_.
...
*recursive*::
    Flag whether to check the directory recursivly. Defaults to _true_.
